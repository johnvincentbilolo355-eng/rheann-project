...
namespace An_Early_Warning_System_for_Student
{
    public partial class AddTeacher : Form
    {
        ...
        private void submit_Click(object sender, EventArgs e)
        {
            ...
            string selectedYearLevel = yearlevel.SelectedIndex == 0 ? null : yearlevel.SelectedItem.ToString();
            // ===== DATABASE INSERT =====
            try
            {
        ...
        private void fname_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                lname.Focus();
        ...
        private void lname_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                DrpStrands.Focus();
        ...
        private void emailaddress_KeyDown_1(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                pass.Focus();
